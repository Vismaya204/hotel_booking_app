          ...
          child: Center(
            child: Column(mainAxisAlignment: MainAxisAlignment.center,
              children: [
                ...
                },child: Align(alignment: Alignment.bottomRight,child: Text("Forgot Password?",style: TextStyle(color: Colors.amber),))),
                SizedBox(height: 20,),
                   ...
                   Padding(
                     ...
                     child: SizedBox(height: 50,width: double.infinity,
                       child: ElevatedButton(
                        ...
                        onPressed: () {Provider.of<HotelBookingController>(context,listen: false).login(
                          email: email.text,
