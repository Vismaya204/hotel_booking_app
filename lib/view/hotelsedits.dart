...
import 'package:hotelbookingapp/view/hotelviewpayment.dart';
import 'package:image_picker/image_picker.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:http/http.dart' as http;

class EditHotelandviewbooking extends StatefulWidget {
  final String hotelId;
  final Map<String, dynamic> hotel;

  const EditHotelandviewbooking({
    super.key,
  ...
  @override
  State<EditHotelandviewbooking> createState() => _EditHotelandviewbooking();
}

class _EditHotelandviewbooking extends State<EditHotelandviewbooking> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) =>Hotelviewpayment(),));},
